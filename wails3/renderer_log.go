...
func createRendererLogger(home string) (*rendererLogger, func(), error) {
...
func createRendererLoggerForCurrentUser() (*rendererLogger, func(), error) {
	home, err := os.UserHomeDir()
	if err != nil {
		return nil, nil, err
	}
	return createRendererLogger(home)
}
