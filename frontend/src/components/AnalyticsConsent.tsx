        ...
        <div className="p-6 pb-0">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <DialogTitle className="text-2xl">{t('settings.enableAnalytics')}</DialogTitle>
            </div>
          ...
          <Card className="p-4 shadow-lg border-purple-200 dark:border-purple-800">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2 flex-1">
                <p className="text-sm font-medium">{t('settings.enableAnalytics')}</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  {t('settings.privacyNoPersonal')}
                </p>
