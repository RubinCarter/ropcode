...
const STORAGE_KEY_PREFIX = 'ropcode_session_';
const SESSION_INDEX_KEY = 'ropcode_session_index';
...
export class SessionPersistenceService {
   ...
   */
  static saveSession(sessionId: string, projectId: string, projectPath: string, provider?: string, messageCount?: number, scrollPosition?: number): void {
    try {
