...
// Message is an alias for provider.Message — the canonical definition lives in provider package.
type Message = provider.Message

// MessageIndex is an alias for provider.MessageIndex.
type MessageIndex = provider.MessageIndex
...
// SessionInfo is an alias for provider.HistorySessionInfo.
type SessionInfo = provider.HistorySessionInfo

// ProjectSessionsResult is an alias for provider.HistorySessionsResult.
type ProjectSessionsResult = provider.HistorySessionsResult
